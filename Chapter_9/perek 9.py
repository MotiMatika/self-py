...
#     all_words = content.split(" ") 
#     print(all_words)  
#     print(len(all_words))               #הפרדת הקובץ למילים בתוך מערך/רשימה
...
# choose_word("f7.txt",-1)               #הפונקציה מקבלת את הנתיב ואת מיקום המילה שתנוחש ע"י המשתמש
